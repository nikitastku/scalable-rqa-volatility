...
def paired_bootstrap_test(y_true: np.ndarray,
    ...
    p_value = float(np.mean(diffs <= 0))  # one-sided: P(B <= A)
...
# ═══════════════════════════════════════════════════════════════
# THRESHOLD TUNING (same as training scripts)
# ═══════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════
# DATASET 1/2: BUILD X, Y, TRAIN, PREDICT
# ═══════════════════════════════════════════════════════════════
...
def run_d12(dataset: int, logger):
    ...
    # ── RQA features (per_series for D2, default for D1) ──
    ...
    # ── β-RQA features (best β per dataset) ──
    ...
    for name_a, name_b, label in comparisons:
        ...
        # Align y_true (should be same but may differ slightly)
    ...
    # Also save predictions for potential later use
...
# ═══════════════════════════════════════════════════════════════
# DATASET 3: PER-STOCK METRICS + WILCOXON
# ═══════════════════════════════════════════════════════════════
...
def run_d3(logger):
    ...
    # ── β-RQA features (β=2.0 best for D3) ──
    ...
    for name_a, name_b, label in comparisons_d3:
        ...
        # Wilcoxon signed-rank test (one-sided: B > A)
        try:
    ...
    # ── Also add bootstrap CIs for pooled metrics ──
